            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm text-right">
                        ...
                        <!-- <a onclick="return confirm('Data pemesanan akan dihapus. anda yakin ingin batal?')" href="<?= base_url('transaksi/delete_item') ?>" class="btn btn-secondary"><i class="fa fa-times"></i> Batal</a>
                    </div> -->
                    </div>
                </div>
