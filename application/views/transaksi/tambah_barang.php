            ...
            <div class="card-header bg-white">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <a href="<?= base_url('transaksi/tambah') ?>" class="btn btn-sm btn-secondary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input value="<?= set_value('id'); ?>" type="text" class="form-control" name="id" id="id" placeholder="Kode Barang...">
                    ...
                    <tbody>
                        <?php foreach ($barang as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row->stok; ?></td>
                                <td>
                                    <button data-stok="<?= $row->stok; ?>" data-kode="<?= $row->id; ?>" type="submit" class="btn btn-pilih btn-sm btn-primary">
